...
#### 数据源实现
| 实现类 | 数据源类型 | 默认QPS | 默认权重 | 可用度评分 |
|--------|------------|-------|----------|------------|
| `LocalIp2RegionResolver` | 本地ip2region库 | x     | 100 | ⭐⭐⭐⭐⭐ |
| `GeoIP2Resolver` | 本地GeoIP2库 | x     | 100 | ⭐⭐⭐⭐⭐ |
| `TaobaoIpResolver` | 淘宝API | 3     | 90 | ⭐⭐⭐⭐ |
| `PacificIpResolver` | Pacific网络API | 1     | 30 | ⭐⭐ |
| `IpApiCoResolver` | ipapi.co API | 2     | 70 | ⭐⭐⭐ |
| `Ip9Resolver` | IP9 API | 1     | 60 | ⭐⭐⭐ |
| `IpInfoResolver` | IPInfo API | 1     | 55 | ⭐⭐⭐ |
| `XxlbResolver` | XXLB API | 1     | 30 | ⭐ |
| `VoreResolver` | Vore API | 1     | 30 | ⭐ |
| `IpMoeResolver` | IP-MOE API | 1     | 30 | ⭐ |
| `ZhengbingdongResolver` | Zhengbingdong API | 1     | 30 | ⭐ |
#### HTTP实现
...
ZhengbingdongResolver zhengbingdongResolver = new ZhengbingdongResolver("Zhengbingdong", 30);
